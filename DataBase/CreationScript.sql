...
CREATE TABLE ITEM (
    ...
    CONSTRAINT FK_ITEM_EMPLOYEE FOREIGN KEY (ID_EMPLOYEE) REFERENCES EMPLOYEE(ID) ON DELETE SET NULL
);
...
INSERT INTO ITEM (ITEM_NAME, SUMMARY, ID_DEPARTMENT, NFS, ID_STATE, ID_EMPLOYEE) 
VALUES ('Laptop', 'Dell Latitude 5400', 3, '1', 1, 1);
