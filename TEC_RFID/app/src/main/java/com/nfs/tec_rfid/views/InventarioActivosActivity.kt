...
class InventarioActivosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        readNfcButton = findViewById(R.id.read_nfc_button)
                ...
                override fun onResponse(call: Call<ItemResponse>, response: Response<ItemResponse>) {
                    when {
                        response.isSuccessful && response.body() != null -> {
                            ...
                            Toast.makeText(this@InventarioActivosActivity, "El activo fue registrado con exito", Toast.LENGTH_SHORT).show()
                            this@InventarioActivosActivity.itemId = itemId.toString()
                            playPingSound()
                        ...
                        response.code() == 401 -> {
                            ...
                            Toast.makeText(this@InventarioActivosActivity, "Tag ya ha sido registrado anteriormente", Toast.LENGTH_SHORT).show()
                            playPingSound()
                            ...
                            // Handle other errors
                            playPingSound()
                            Toast.makeText(this@InventarioActivosActivity, "Hubo un error al registrar el activo, por favor volver a intentarlo", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
        ...
        call.enqueue(object : Callback<List<Department>> {
            override fun onResponse(call: Call<List<Department>>, response: Response<List<Department>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@InventarioActivosActivity, "Failed to load departments", Toast.LENGTH_SHORT).show()
                }
            }
        ...
        call.enqueue(object : Callback<List<Cycle>> {
            override fun onResponse(call: Call<List<Cycle>>, response: Response<List<Cycle>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@InventarioActivosActivity, "Failed to load cycles", Toast.LENGTH_SHORT).show()
                }
            }
